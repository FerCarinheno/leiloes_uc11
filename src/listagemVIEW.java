...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    produto.setId(Integer.parseInt(id_produto_venda.getText())); // Defina o ID do produto que deseja vender
    produto.setStatus("Vendido"); // Defina o nome do produto
    produto.setValor(550.0);
    produto.setNome("Módulo");
    
    
    // Chama o método para atualizar o produto como vendido
